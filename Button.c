...
{
    g_Button_Config.pin_num= BUTTON_PORT_PIN_NUM;             // Set Button PORT_Number value 
    g_Button_Config.pin_num   = BUTTON_PIN_NUM;          //t Button PIN Number value 
    g_Button_Config.= INPUT;                   //Set Button as INPUT pin 
    g_Button_Config.resistor  = PULL_UP;                 // Enable Intrnal pull up at this pin 
    g_Button_Config.initial_value  = BUTTON_RELEASED;    // Button is released HIIGH
}
*/
/*******************************************************************************************************************/
